  ...
  return (
    ...
    >
      ...
      <p className={styles.qvFootNote}>
        Generated by EMV CRM · Global Ease My Vacations (OPC) Private Limited · CIN: U72900WB2022PTC254985 · GST: 19AAHCE1058Q2Z2 · Prepared by {quote.agentName || 'EMV Team'}
      </p>
  ...
  return (
    <div style={{ fontFamily: 'Georgia, serif', color: '#111', background: '#fff', maxWidth: 860, margin: '0 auto' }}>
      ...
      <div style={{ borderTop: '2px solid #c9a96e', paddingTop: 14, marginTop: 14, display: 'flex', justifyContent: 'space-between' }}>
        <div style={{ fontFamily: 'Arial, sans-serif', fontSize: 11, color: '#888' }}>Global Ease My Vacations (OPC) Private Limited · CIN: U72900WB2022PTC254985 · GST: 19AAHCE1058Q2Z2</div>

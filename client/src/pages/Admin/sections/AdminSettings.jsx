  ...
  return (
    <div className={styles.page}>
      ...
      <SettingsSection title="WhatsApp Integration" delay={0.2}>
        <div className={styles.stack}>
          <div className={styles.waBox}>
            ...
            <div>
              <p className={styles.notifLabel}>WhatsApp Business</p>
              <p className={styles.waNumber}>{profile.whatsappNumber || 'Not configured'}</p>
            </div>
          </div>
          <div className={styles.fieldRow}>
            <label className={styles.fieldLabel}>Business Number</label>
            <input
          ...
          <div className={styles.fieldCol}>
            <label className={styles.fieldLabel}>Default Message Template</label>
            <textarea
      ...
      <div className={styles.saveRow}>
        <button onClick={handleReset} className={styles.btnOutline}>Reset</button>
        <button
          onClick={handleSave}
          disabled={saving}

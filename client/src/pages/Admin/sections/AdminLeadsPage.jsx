...
const emptyForm = { name: '', phone: '', email: '', message: '', status: 'new' }
      ...
      >
        ...
        <div className="space-y-5">
          {[
            ...
            { label: 'Inquiry Message', key: 'message', placeholder: 'What are they looking for?', required: false },
          ].map(field => (
            <div key={field.key}>
            ...
            <table className="w-full text-sm text-gray-600">
              <thead className="bg-gray-50 text-[10px] uppercase text-gray-400 font-black border-b border-gray-100 tracking-[0.2em]">
                <tr>
                  ...
                  <th className="px-8 py-5 text-left">Inquiry</th>
                  ...
                  return (
                    ...
                    >
                      <td className="px-8 py-5">
                        ...
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">{lead.phone}</p>
                      </td>
                      <td className="px-8 py-5 max-w-[220px]">
                        <p className="font-medium text-dark truncate">{lead.message || '—'}</p>
                        <p className="text-[10px] text-gray-400 font-bold mt-0.5">{lead.email || ''}</p>
                      </td>
                      <td className="px-8 py-5 text-gray-500 font-medium hidden md:table-cell whitespace-nowrap">
                        {formatDate(lead.created_at)}
                      </td>
                      <td className="px-8 py-5">
                        <span className={`px-3.5 py-1.5 rounded-full text-[10px] font-black border uppercase tracking-[0.15em] ${statusStyles[lead.status] || 'bg-gray-50 text-gray-500 border-gray-100'}`}>
                          {lead.status}
                        </span>
                      </td>

...
export default function DataProcessingAgreement() {
  return (
    ...
    >
      ...
      <P><Strong>Processor:</Strong> EMV processing data on behalf of the Controller.</P>
      ...
      <P>EMV may process personal data for:</P>
      <Ul items={[
      ...
      <Section title="4. Obligations of EMV" />
      <P>EMV agrees to:</P>
      <Ul items={[
      ...
      <P>EMV maintains technical and organizational measures including:</P>
      <Ul items={[
      ...
      <P>EMV may engage approved sub-processors including cloud providers, payment processors, and communication service providers. EMV remains responsible for compliance obligations of sub-processors.</P>
      ...
      <P>Upon termination of services, EMV shall securely delete or return personal data unless retention is legally required by applicable regulations.</P>

      <Section title="9. Audit Rights" />
      <P>Enterprise customers may request reasonable compliance documentation relating to EMV's data processing practices subject to confidentiality requirements.</P>

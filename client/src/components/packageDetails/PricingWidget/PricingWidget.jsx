...
import { splitTitle } from '../../../utils/packageContent'
...
export default function PricingWidget({ pkg, onRequestQuote }) {
  ...
  const details = [
    nights > 0 && { icon: '📅', label: 'Duration',  value: `${nights} Nights / ${nights + 1} Days` },
    ...
    >
      ...
      <div className={styles.priceSec}>
        ...
        <p className={styles.priceNote}>
          Prices vary by travel dates, hotel category and availability. Get a personalised quote
          from our travel expert.
        </p>
      </div>

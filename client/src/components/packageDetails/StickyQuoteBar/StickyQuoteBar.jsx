...
import styles from './StickyQuoteBar.module.css'
...
export default function StickyQuoteBar({ pkg, onRequestQuote }) {
    ...
    >
        ...
        {price ? (
          <>
            ...
            <span className={styles.priceValue}>
              {price} <span className={styles.pricePer}>/ person</span>
            </span>
          </>
        ) : (
          <>
            <span className={styles.priceLabel}>Your price</span>
            <span className={styles.priceValue} style={{ fontSize: '0.9375rem' }}>
      ...
      <div className={styles.actions}>
        <button
          ...
          aria-label="WhatsApp a travel expert"
        >
